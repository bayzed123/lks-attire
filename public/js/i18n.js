...
export const dict = {
  en: {
    ...
    free: "Free", couponCode: "Coupon code", applyCoupon: "Apply", couponApplied: "Coupon applied", removeCoupon: "Remove coupon",
    ...
    thankYou: "Thank you! Your order is placed.", orderNumber: "Order number", confirmCall: "We'll call you on {phone} to confirm. Keep your phone nearby.",
  ...
  bn: {
    ...
    free: "ফ্রি", couponCode: "কুপন কোড", applyCoupon: "প্রয়োগ করুন", couponApplied: "কুপন প্রয়োগ হয়েছে", removeCoupon: "কুপন সরান",
    ...
    thankYou: "ধন্যবাদ! আপনার অর্ডার সম্পন্ন হয়েছে।", orderNumber: "অর্ডার নম্বর", confirmCall: "কনফার্ম করতে আমরা {phone} নম্বরে কল করব। ফোনটি কাছে রাখুন।",
