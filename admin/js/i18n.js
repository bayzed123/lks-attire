...
const dict = {
  en: {
    ...
    collapse: "Collapse menu", search: "Search orders, products, customers…", profile: "Profile settings", signOut: "Sign out", notifications: "Notifications",
    ...
    templatesHelp: "You can use {name}, {order_no}, {total}, {courier}, {tracking}, {store}.",
    signInTitle: "Staff sign in", email: "Email", password: "Password", signIn: "Sign in", signingIn: "Signing in…",
  ...
  bn: {
    ...
    collapse: "মেনু ছোট করুন", search: "অর্ডার, পণ্য, গ্রাহক খুঁজুন…", profile: "প্রোফাইল সেটিংস", signOut: "সাইন আউট", notifications: "নোটিফিকেশন",
    ...
    templatesHelp: "ব্যবহার করতে পারেন: {name}, {order_no}, {total}, {courier}, {tracking}, {store}",
    signInTitle: "স্টাফ সাইন ইন", email: "ইমেইল", password: "পাসওয়ার্ড", signIn: "সাইন ইন", signingIn: "সাইন ইন হচ্ছে…",
